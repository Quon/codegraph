...
`));
    ...
    projectCmd
        ...
        const projects = (0, projects_1.loadProjects)(projectRoot);
        ...
        for (const relPath of projects) {
            ...
            if ((0, directory_1.isInitialized)(absPath)) {
                available++;
    ...
    projectCmd
        ...
        .action((pathArg) => {
        const projectRoot = resolveProjectPath(process.cwd());
        (0, projects_1.addProject)(projectRoot, pathArg);
    ...
    projectCmd
        ...
        .action((pathArg) => {
        const projectRoot = resolveProjectPath(process.cwd());
        (0, projects_1.removeProject)(projectRoot, pathArg);
    ...
    projectCmd
        ...
        const merged = (0, projects_1.syncProjects)(projectRoot, depth);
        if (merged.length === 0) {
            ...
            for (const p of merged) {
                ...
                const status = (0, directory_1.isInitialized)(absPath)
                    ? chalk.green('✓')
